...
#         para un indice especifico en el ultimo periodo disponible
#

consolidados<-function(index_id,graba=0) {

     # Si graba=0 entonces los valores son devueltos a la linea de comandos como tabla
     # Si graba=1 entonces los valores son grabados en un archivo y NO en la linea
     #    de comando.
     ...
     if (dim(cells)[1]==0) {
          stop('El indice no contiene datos en ningun periodo.')
     }
